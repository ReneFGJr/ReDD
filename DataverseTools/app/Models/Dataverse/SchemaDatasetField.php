...
class SchemaDatasetField extends Model
{
    ...
    protected $allowedFields    = [
        'm_schema', 'm_name', 'm_title',
        'm_description', 'm_watermark', 'm_fieldType',
        'm_displayOrder', 'm_displayFormat', 'm_advancedSearchField',
        'm_allowControlledVocabulary', 'm_allowmultiples', 'm_facetable',
        'm_displayoncreate', 'm_required', 'm_parent',
        'm_termURI', 'active'
    ];

    protected $typeFields    = [
        'hidden','string:100','string:100',
        'text','string:100','string:100',
        '[1-100]','string:100','sn',
        'sn','sn','sn',
        'sn','sn','string:100',
        'url','sn'
    ...
    function datafieldEd($id)
        {
            $this->id = $id;
            $this->path = PATH.'index/schema/datafieldEd/'.$id;
            $sx = form($this);
            $sx = bs(bsc($sx));
            return $sx;
        }
            ...
            for ($r=0;$r < count($dt);$r++)
                {
                    ...
                    $sx .= '<td>'.onclick(PATH.'index/schema/datafieldEd/'.$ln['id_m'],800,600).bsicone('edit',16).'</span></td>';                      
                    $sx .= '</tr>';
                }
            $sx .= '</table>';
