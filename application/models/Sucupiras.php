        ...
        function process()
            {
                ...
                $p = array('ARQUIVÍSTICA','Arquivistica','arquivística','Arquivística','Arquivística','ARQUIVÍSTICO','Arquivístico','arquivístico');
                $d = array();
                $q = array('Arquivologia','arquivologia');
                echo '<table>';
                for ($r=0;$r < count($c);$r++)
                    {
                        ...
                        for ($y=0;$y < count($q);$y++)
                            {
                                $tr = '<span style="background-color: #a0a0ff;">'.UpperCase($q[$y]).'</span>';
                                $sx = troca($sx,$q[$y],$tr);        
                            }
