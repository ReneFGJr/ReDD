...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url('index.php/main'); ?>"><span class="glyphicon glyphicon-list" style="color: red;" aria-hidden="true"></span> <font color="blue">Authority</font></a>
		</div>
